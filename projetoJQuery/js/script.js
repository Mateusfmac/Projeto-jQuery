...
var m = n.getMonth() + 1;
var d = n.getDate();
var vhora = n.getHours();
var vminuto = n.getMinutes();
var vsegundo = n.getSeconds();
document.getElementById("date").innerHTML = d + "/" +  m + "/" + y + "   " + "Horas:"+" "+ vhora+":"+ vminuto + ":" + vsegundo + "(Horário de Brasília)";
...
function alteracoes() {
  document.getElementById("novologo").src = "./img/novo-logo.png";
  document.getElementById("imgtopo").src = "./img/new-top-header.png";
  ...
  document.getElementById("principal").style.fontStyle =
    "'Roboto', sans-serif;";
}

function antigo() {
  document.getElementById("novologo").src = "./img/logo.png";
  document.getElementById("imgtopo").src = "./img/home-1.png";
